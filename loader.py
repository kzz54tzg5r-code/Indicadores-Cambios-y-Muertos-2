...
def apply_styles():
    ...
    .top-header {{
        ...
        padding:14px 24px; display:grid; grid-template-columns:140px 1fr 380px; gap:20px; align-items:center;
    }}
    ...
    @media (max-width:900px) {{ .top-header {{ grid-template-columns:90px 1fr; }} .header-controls {{ display:none; }} }}
    </style>
